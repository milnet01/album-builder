...
**Status:** Draft · **Last updated:** 2026-04-28 · **Depends on:** 00 · **Used by:** 03, 04, 05, 06, 07, 09, 12 (every UI-bearing spec)
...
3. The cover-page header of the report (Spec 09), small at the bottom: "Generated by [icon] Album Builder · v{version}". The version string is read from `src/album_builder/version.py: __version__` at *render* time, not at build / template-compile time, so a version bump propagates without a template edit.
